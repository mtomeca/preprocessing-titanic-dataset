...
###CONVERTIR ALGUNES VARIABLES###

1. Convertir la variable *Age* a tipus Integer

2. Fer un split de la variable *Name* per separar nom i cognom. Ens pot aportar informació a l'hora d'entrenar l'algorisme i poder predir millor les dades del conjunt train.

3. Convertir variable *Pclass* a factor.

```{r}
#  Convertir la variable *Age* a tipus Integer
data$Age <- as.integer(data$Age)

# Fer un split de la variable *Name* per separar nom i cognom
data$Name <- as.character(data$Name)
data <- data %>%
  separate(Name, c("Surname", "Name"), ",")

# Convertir variable *Pclass* a factor
...
cat("\nValors perduts de la columna 'Survived' del conjunt de train: ", sum(is.na(data$Survived[data$train_test == "train"])))
```
